...
[task_local]
#京东炸年兽小程序🧨
50 8 * * * qx_nian_wechat.js, tag=京东炸年兽小程序🧨, enabled=true

================Loon==============
[Script]
cron "50 8 * * *" script-path=qx_nian_wechat.js,tag=京东炸年兽小程序🧨

===============Surge=================
京东炸年兽小程序🧨 = type=cron,cronexp="50 8 * * *",wake-system=1,timeout=3600,script-path=qx_nian_wechat.js

============小火箭=========
京东炸年兽小程序🧨 = type=cron,script-path=qx_nian_wechat.js, cronexpr="50 8 * * *", timeout=3600, enable=true
 */
