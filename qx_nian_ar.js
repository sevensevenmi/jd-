...
[task_local]
#京东炸年兽AR
0 9 * * * qx_nian_ar.js, tag=京东炸年兽AR, enabled=true

================Loon==============
[Script]
cron "0 9 * * *" script-path=qx_nian_ar.js,tag=京东炸年兽AR

===============Surge=================
京东炸年兽AR = type=cron,cronexp="0 9 * * *",wake-system=1,timeout=36000,script-path=qx_nian_ar.js

============小火箭=========
京东炸年兽AR = type=cron,script-path=qx_nian_ar.js, cronexpr="0 9 * * *", timeout=3600, enable=true
 */
