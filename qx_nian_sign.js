...
[task_local]
#京东炸年兽签到任务🧨
30 8 * * * qx_nian_sign.js, tag=京东炸年兽签到任务🧨, enabled=true

================Loon==============
[Script]
cron "30 8 * * *" script-path=qx_nian_sign.js,tag=京东炸年兽签到任务🧨

===============Surge=================
京东炸年兽签到任务🧨 = type=cron,cronexp="30 8 * * *",wake-system=1,timeout=3600,script-path=qx_nian_sign.js

============小火箭=========
京东炸年兽签到任务🧨 = type=cron,script-path=qx_nian_sign.js, cronexpr="30 8 * * *", timeout=3600, enable=true
 */
