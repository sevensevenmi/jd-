...
function getJxToken(){
	function _0x23cb77(_0x378208){
		let _0x36ad34='abcdefghijklmnopqrstuvwxyz1234567890';
		let _0x3ba0b7='';
		for(let _0x24b162=0;_0x24b162<_0x378208;_0x24b162++){
			_0x3ba0b7+=_0x36ad34[parseInt(Math.random()*_0x36ad34.length)];
		}
		return _0x3ba0b7;
	}
	return new Promise(_0x2ef875=>{
		let _0x9ac908=_0x23cb77(40);
		let _0x256650=(+new Date()).toString();
		if(!cookie.match(/pt_pin=([^; ]+)(?=;?)/)){
			console.log('此账号cookie填写不规范,你的pt_pin=xxx后面没分号(;)\n');
			_0x2ef875(null);
		}
		let _0x4e1006=cookie.match(/pt_pin=([^; ]+)(?=;?)/)[1];
		let _0x57bff6=$.md5(''+decodeURIComponent(_0x4e1006)+_0x256650+_0x9ac908+'tPOamqCuk9NLgVPAljUyIHcPRmKlVxDy').toString();
		_0x2ef875({'timestamp':_0x256650,'phoneid':_0x9ac908,'farm_jstoken':_0x57bff6});
	});
};
