/*
城城领现金
by: https://raw.githubusercontent.com/sevensevenmi/jd-/c3ea30e32c725b2c1a0c678018cc5c9425317890/qx_city.js
脚本兼容: QuantumultX, Surge,Loon, JSBox, Node.js
=================================Quantumultx=========================
[task_local]
#城城领现金
0 0-23/1 * * * https://raw.githubusercontent.com/sevensevenmi/jd-/c3ea30e32c725b2c1a0c678018cc5c9425317890/qx_city.js, tag=城城领现金, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

=================================Loon===================================
[Script]
cron "0 0-23/1 * * *" script-path=https://raw.githubusercontent.com/jiulan/platypus/main/scripts/jd_city.js,tag=城城领现金

===================================Surge================================
城城领现金 = type=cron,cronexp="0 0-23/1 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/sevensevenmi/jd-/c3ea30e32c725b2c1a0c678018cc5c9425317890/qx_city.js

====================================小火箭=============================
城城领现金 = type=cron,script-path=https://raw.githubusercontent.com/sevensevenmi/jd-/c3ea30e32c725b2c1a0c678018cc5c9425317890/qx_city.js, cronexpr="0 0-23/1 * * *", timeout=3600, enable=true
 */
const $ = new Env('城城领现金');
...
!(async () => {
  ...
  inviteCodes = ["ryUX6oEYmwQZ0TFH4jG_2sQkm4QUOW3"]
  for (let i = 0; i < cookiesArr.length; i++) {
    cookie = cookiesArr[i];
    $.UserName = decodeURIComponent(cookie.match(/pt_pin=([^; ]+)(?=;?)/) && cookie.match(/pt_pin=([^; ]+)(?=;?)/)[1])
    $.index = i + 1;
...
function readShareCode() {
  return new Promise(async resolve => {
    $.get({url: `https://qxhut.cn/json/city.json`, 'timeout': 15000}, (err, resp, data) => {
      try {
        if (err) {
          console.log(`${JSON.stringify(err)}`)
          console.log(`${$.name} API请求失败，请检查网路重试`)
