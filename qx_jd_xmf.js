...
[task_local]
#京东小魔方
30 3,20 * * * qx_jd_xmf.js, tag=京东小魔方, img-url=, enabled=true

================Loon==============
[Script]
cron "30 3,20 * * *" script-path=qx_jd_xmf.js, tag=京东小魔方

===============Surge=================
京东小魔方 = type=cron,cronexp="30 3,20 * * *",wake-system=1,timeout=3600,script-path=qx_jd_xmf.js

============小火箭=========
京东小魔方 = type=cron,script-path=qx_jd_xmf.js, cronexpr="30 3,20 * * *", timeout=3600, enable=true
 */
