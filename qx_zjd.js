...
async function requestAlgo(){
	var _0x4c279a='',_0x3cf7b2='0123456789',_0x32e98d=_0x3cf7b2,_0x54cb36=(Math.random()*0xa|0x0);
	do{
		ss=getRandomIDPro({'size':1,'customDict':_0x3cf7b2})+'';
		if(_0x4c279a.indexOf(ss)==-1)_0x4c279a+=ss;
	}while(_0x4c279a.length<3);
	for(let _0x48780e of _0x4c279a.slice())_0x32e98d=_0x32e98d.replace(_0x48780e,'');
	$.fp=(getRandomIDPro({'size':_0x54cb36,'customDict':_0x32e98d})+''+_0x4c279a)+getRandomIDPro({'size':(14-_0x54cb36+3+1),'customDict':_0x32e98d})+_0x54cb36+'';
	$.fp='9358677227970792';
	let _0x5b175b={
		'url':'https://cactus.jd.com/request_algo?g_ty=ajax','headers':{
			'Accept':'application/json','Content-Type':'application/json','Accept-Encoding':'gzip, deflate, br','Accept-Language':'zh-CN,zh;q=0.9,en;q=0.8','host':'cactus.jd.com','Referer':'https://cactus.jd.com','User-Agent':'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36 MicroMessenger/7.0.9.501 NetType/WIFI MiniProgramEnv/Windows WindowsWechat',
	...
	return new Promise(async _0x53c7f3=>{
		$.post(_0x5b175b,(_0x2c2c84,_0x1b3374,_0x41f319)=>{
			try{
				const{
					ret,msg,data:{
						result
...
function getRandomIDPro(){
	var _0x5f0a7a,_0x484f6f,_0x2b28ff=(void 0===_0x58ef1d=(_0x484f6f=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{}).size)?10:_0x58ef1d,_0x58ef1d=(void 0===_0x58ef1d=_0x484f6f.dictType)?'number':_0x58ef1d,_0x1f2fbe='';
	if((_0x484f6f=_0x484f6f.customDict)&&('string'==typeof _0x484f6f))_0x5f0a7a=_0x484f6f;else switch(_0x58ef1d){
		case 'alphabet':
			_0x5f0a7a='abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';
			break;
		case 'max':
		...
		case 'number':
		default:
			_0x5f0a7a='0123456789';
	}
	for(;_0x2b28ff--;)_0x1f2fbe+=_0x5f0a7a[Math.random()*_0x5f0a7a.length|0x0];
	return _0x1f2fbe;
}
function h5stSign(_0x16a27f){
	let _0x137258=[{'key':'appid','value':'activities_platform'},{'key':'body','value':$.CryptoJS.SHA256($.toStr(_0x16a27f,_0x16a27f)).toString()},{'key':'client','value':'applet'},{'key':'clientVersion','value':'1.0.0'},{'key':'functionId','value':'vvipclub_distributeBean_startAssist'},{'key':'t','value':Date.now()}];
	let _0x2d7791=_0x137258.map(function(_0x2d64bd){
		return (_0x2d64bd.key+':')+_0x2d64bd.value;
	}).join('&');
	let _0x4fa26b=Date.now();
	let _0x3ed202='';
	let _0x2cecaf=format('yyyyMMddhhmmssSSS',_0x4fa26b);
	_0x3ed202=$.genKey($.token,$.fp.toString(),_0x2cecaf.toString(),'63d78'.toString(),$.CryptoJS).toString();
	const _0x1c4805=$.CryptoJS.HmacSHA256(_0x2d7791,_0x3ed202.toString()).toString();
	let _0x55c9fe=[''.concat(_0x2cecaf.toString()),''.concat($.fp.toString()),''.concat('63d78'.toString()),''.concat($.token),''.concat(_0x1c4805),'3.1',''.concat(_0x4fa26b)].join(';')return encodeURIComponent(_0x55c9fe);
}
function format(_0x3b3946,_0x57ab39){
	if(!_0x3b3946)_0x3b3946='yyyy-MM-dd';
	var _0x119460;
	if(!_0x57ab39){
		_0x119460=Date.now();
	}else{
	...
	var _0xd7a8f2,_0x514fe8=new Date(_0x119460),_0x117011=_0x3b3946,_0x589edc={'M+':(_0x514fe8.getMonth()+1),'d+':_0x514fe8.getDate(),'D+':_0x514fe8.getDate(),'h+':_0x514fe8.getHours(),'H+':_0x514fe8.getHours(),'m+':_0x514fe8.getMinutes(),'s+':_0x514fe8.getSeconds(),'w+':_0x514fe8.getDay(),'q+':Math.floor(_0x514fe8.getMonth()+3/3),'S+':_0x514fe8.getMilliseconds()};
	/(y+)/i.test(_0x117011)&&(_0x117011=_0x117011.replace(RegExp.$1,''.concat(_0x514fe8.getFullYear()).substr(4-RegExp.$1.length)));
	Object.keys(_0x589edc).forEach(_0xd7a8f2=>{
		if(new RegExp('('.concat(_0xd7a8f2,')')).test(_0x117011)){
			var _0x119460,_0x3b3946='S+'===_0xd7a8f2?'000':'00';
			_0x117011=_0x117011.replace(RegExp.$1,1==RegExp.$1.length?_0x589edc[_0xd7a8f2]:''.concat(_0x3b3946).concat(_0x589edc[_0xd7a8f2]).substr(''.concat(_0x589edc[_0xd7a8f2]).length));
		}
	});
	return _0x117011;
};
