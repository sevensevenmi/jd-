...
[task_local]
#秒秒币
30 8 * * * qx_jd_ms.js, tag=秒秒币, img-url=, enabled=true

================Loon==============
[Script]
cron "30 8 * * *" script-path=qx_jd_ms.js, tag=秒秒币

===============Surge=================
秒秒币 = type=cron,cronexp="30 8 * * *",wake-system=1,timeout=3600,script-path=qx_jd_ms.js

============小火箭=========
秒秒币 = type=cron,script-path=qx_jd_ms.js, cronexpr="30 8 * * *", timeout=3600, enable=true
 */
