...
==============Loon==============
[Script]
cron "0 0,10 * * *" script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_jxlhb.js,tag=京喜领88元红包

================Surge===============
京喜领88元红包 = type=cron,cronexp="0 0,10 * * *",wake-system=1,timeout=3600,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_jxlhb.js

===============小火箭==========
京喜领88元红包 = type=cron,script-path=https://raw.githubusercontent.com/Aaron-lv/sync/jd_scripts/jd_jxlhb.js, cronexpr="0 0,10 * * *", timeout=3600, enable=true
 */
...
!(async () => {
    ...
    console.log('京喜领88元红包\n' +
        ...
        '温馨提示：如提示助力火爆，可尝试寻找京东客服')
    let res = []
    res = await getAuthorShareCode('http://qxhut.cn/json/jxhb.json')
